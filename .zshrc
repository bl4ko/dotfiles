...
if [ ! -f ~/.zsh/zsh-git-prompt/zshrc.sh ]; then
    ...
    git clone -v https://github.com/olivierverdier/zsh-git-prompt.git ~/.zsh/zsh-git-prompt
fi
...
if [ ! -f ~/.zsh/zsh-autosuggestions/zsh-autosuggestions.zsh ]; then
    ...
    git clone -v https://github.com/zsh-users/zsh-autosuggestions ~/.zsh/zsh-autosuggestions
fi
# Source the plugin
